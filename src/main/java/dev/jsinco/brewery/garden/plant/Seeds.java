...
public record Seeds(String simpleName, PlantType plantType, @Nullable ItemStack itemOverride) implements PlantItem {
    ...
    public ItemStack newItem(int amount) {
        ItemStack item = IntegrationItemResolver.resolve(plantType.seedMaterial())
                .orElse(ItemStack.of(Material.WHEAT_SEEDS));
